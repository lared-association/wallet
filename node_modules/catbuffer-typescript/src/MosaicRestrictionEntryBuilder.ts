 ...
 **/
export class MosaicRestrictionEntryBuilder implements Serializer {
    ...
    public static loadFromBinary(payload: Uint8Array): MosaicRestrictionEntryBuilder {
        ...
        return new MosaicRestrictionEntryBuilder(entryType, addressEntry, globalEntry);
    }
    ...
    public static createMosaicRestrictionEntryBuilderAddress(
        ...
        return new MosaicRestrictionEntryBuilder(entryType, addressEntry, undefined);
    }
    ...
    public static createMosaicRestrictionEntryBuilderGlobal(
        ...
        return new MosaicRestrictionEntryBuilder(entryType, undefined, globalEntry);
    }
