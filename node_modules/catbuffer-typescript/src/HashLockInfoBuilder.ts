 ...
 **/
export class HashLockInfoBuilder implements Serializer {
    /** Owner address. **/
     ...
     * @param hash Hash.
     */
    public constructor(ownerAddress: AddressDto, mosaic: MosaicBuilder, endHeight: HeightDto, status: LockStatusDto, hash: Hash256Dto) {
