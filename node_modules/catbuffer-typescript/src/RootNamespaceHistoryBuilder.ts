 ...
 **/
export class RootNamespaceHistoryBuilder implements Serializer {
    ...
    readonly rootAlias: NamespaceAliasTypeDto;
    ...
    public static loadFromBinary(payload: Uint8Array): RootNamespaceHistoryBuilder {
        ...
        const rootAlias: NamespaceAliasTypeDto = GeneratorUtils.bufferToUint8(Uint8Array.from(byteArray));
    ...
    public serialize(): Uint8Array {
        ...
        const rootAliasBytes = GeneratorUtils.uint8ToBuffer(this.rootAlias);
