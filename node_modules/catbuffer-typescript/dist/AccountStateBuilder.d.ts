...
export declare class AccountStateBuilder implements Serializer {
    ...
    constructor(address: AddressDto, addressHeight: HeightDto, publicKey: KeyDto, publicKeyHeight: HeightDto, accountType: AccountTypeDto, format: AccountStateFormatDto, supplementalPublicKeysMask: AccountKeyTypeFlagsDto[], linkedPublicKey: KeyDto | undefined, nodePublicKey: KeyDto | undefined, vrfPublicKey: KeyDto | undefined, votingPublicKeys: PinnedVotingKeyBuilder[], importanceSnapshots: ImportanceSnapshotBuilder | undefined, activityBuckets: HeightActivityBucketsBuilder | undefined, balances: MosaicBuilder[]);
    ...
    static createAccountStateBuilderRegular(address: AddressDto, addressHeight: HeightDto, publicKey: KeyDto, publicKeyHeight: HeightDto, accountType: AccountTypeDto, supplementalPublicKeysMask: AccountKeyTypeFlagsDto[], linkedPublicKey: KeyDto, nodePublicKey: KeyDto, vrfPublicKey: KeyDto, votingPublicKeys: PinnedVotingKeyBuilder[], balances: MosaicBuilder[]): AccountStateBuilder;
    ...
    getNodePublicKey(): KeyDto;
    getVrfPublicKey(): KeyDto;
