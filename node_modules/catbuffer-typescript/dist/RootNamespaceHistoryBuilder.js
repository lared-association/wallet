...
class RootNamespaceHistoryBuilder {
    ...
    static loadFromBinary(payload) {
        ...
        const rootAlias = GeneratorUtils_1.GeneratorUtils.bufferToUint8(Uint8Array.from(byteArray));
    ...
    static createRootNamespaceHistoryBuilder(id, ownerAddress, lifetime, rootAlias, paths) {
        return new RootNamespaceHistoryBuilder(id, ownerAddress, lifetime, rootAlias, paths);
    }
    getId() {
        return this.id;
    ...
    serialize() {
        ...
        const rootAliasBytes = GeneratorUtils_1.GeneratorUtils.uint8ToBuffer(this.rootAlias);
