...
<head>
    <title>Code coverage report for symbol-qr-library/src/EncryptedPayload.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">symbol-qr-library/src</a> EncryptedPayload.ts</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >            throw new Error('Invalid json body in payload! ' + e.message);</span>
        }
        return jsonObject;
    }
&nbsp;
