...
<head>
    <title>Code coverage report for symbol-qr-library/src/schemas/ExportAddressDataSchema.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">symbol-qr-library/src/schemas</a> ExportAddressDataSchema.ts</h1>
        <div class='clearfix'>
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!jsonObj.type ||jsonObj.type !== QRCodeType.ExportAddress) {
<span class="cstat-no" title="statement not covered" >            throw Error('Invalid type field value for AddressQR.');</span>
        }
&nbsp;
        // read contact data
