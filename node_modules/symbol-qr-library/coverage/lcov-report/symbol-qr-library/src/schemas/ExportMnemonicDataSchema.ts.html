...
<head>
    <title>Code coverage report for symbol-qr-library/src/schemas/ExportMnemonicDataSchema.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">symbol-qr-library/src/schemas</a> ExportMnemonicDataSchema.ts</h1>
        <div class='clearfix'>
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!jsonObj.type || jsonObj.type !== QRCodeType.ExportMnemonic) {
<span class="cstat-no" title="statement not covered" >            throw new Error('Invalid type field value for MnemonicQR.');</span>
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!jsonObj.hasOwnProperty('data')) {
<span class="cstat-no" title="statement not covered" >            throw new Error('Missing mandatory property for encrypted payload.');</span>
        }
&nbsp;
        try {
