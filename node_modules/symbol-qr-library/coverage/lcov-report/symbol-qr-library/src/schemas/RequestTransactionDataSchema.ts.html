...
<head>
    <title>Code coverage report for symbol-qr-library/src/schemas/RequestTransactionDataSchema.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">symbol-qr-library/src/schemas</a> RequestTransactionDataSchema.ts</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >            throw Error('JSON argument cannot be empty.');</span>
        }
&nbsp;
        const jsonObj = JSON.parse(json);
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!jsonObj.type || jsonObj.type !== QRCodeType.RequestTransaction) {
<span class="cstat-no" title="statement not covered" >            throw Error('Invalid type field value for TransactionQR.');</span>
        }
&nbsp;
        // read contact data
