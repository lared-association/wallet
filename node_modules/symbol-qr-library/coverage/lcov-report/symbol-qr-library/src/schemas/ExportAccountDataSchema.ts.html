...
<head>
    <title>Code coverage report for symbol-qr-library/src/schemas/ExportAccountDataSchema.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">symbol-qr-library/src/schemas</a> ExportAccountDataSchema.ts</h1>
        <div class='clearfix'>
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!jsonObj.type || jsonObj.type !== QRCodeType.ExportAccount) {
<span class="cstat-no" title="statement not covered" >            throw new Error('Invalid type field value for AccountQR.');</span>
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!jsonObj.hasOwnProperty('data')) {
<span class="cstat-no" title="statement not covered" >            throw new Error('Missing mandatory property for payload.');</span>
        }
&nbsp;
        try {
            // decrypt private key
...
&nbsp;
            ...
            if (!privKey || (privKey.length !== 64 &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >privKey.length !== 66)</span>) {
