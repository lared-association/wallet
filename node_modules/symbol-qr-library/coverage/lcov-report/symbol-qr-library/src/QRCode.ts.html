...
<head>
    <title>Code coverage report for symbol-qr-library/src/QRCode.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">symbol-qr-library/src</a> QRCode.ts</h1>
        <div class='clearfix'>
...
&nbsp;
     ...
     * @return {number}
     */
<span class="fstat-no" title="function not covered" >    public g</span>etCorrectionLevel(): CorrectionLevel {
...
&nbsp;
     ...
     */
    public toBase64(
        <span class="missing-if-branch" title="else path not taken" >E</span>settings: QRCodeSettings = new QRCodeSettings(),
    ): Observable&lt;string&gt; {
&nbsp;
...
&nbsp;
    ...
    public toString(
        <span class="missing-if-branch" title="else path not taken" >E</span>settings: QRCodeSettings = new QRCodeSettings(),
        <span class="missing-if-branch" title="else path not taken" >E</span>streamType: QRCodeStreamType = QRCodeStreamType.Terminal,
    ): Observable&lt;string&gt; {
&nbsp;
        // get JSON representation
        const json = this.toJSON();
...
&nbsp;
     ...
     * @return  {Observable&lt;string&gt;}
     */
<span class="fstat-no" title="function not covered" >    public t</span>oObject(
<span class="cstat-no" title="statement not covered" >        settings: QRCodeSettings = new QRCodeSettings(),</span>
    ): Observable&lt;any&gt; {
&nbsp;
        // get JSON representation
        const json = <span class="cstat-no" title="statement not covered" >this.toJSON();</span>
&nbsp;
        // build the QR Code
<span class="cstat-no" title="statement not covered" >        return observableFrom([QRCodeCanvas.create(json, {</span>
            errorCorrectionLevel: settings.correctionLevel,
            // do-not-set-'width'
            // do-not-set-'version'
        })]);
...
&nbsp;
     ...
     * @return  {Observable&lt;string&gt;}
     */
<span class="fstat-no" title="function not covered" >    public t</span>oCanvas(
<span class="cstat-no" title="statement not covered" >        settings: QRCodeSettings = new QRCodeSettings(),</span>
    ): Observable&lt;string&gt; {
&nbsp;
        // get JSON representation
...
&nbsp;
        // create canvas
        const canvas = <span class="cstat-no" title="statement not covered" >createCanvas(250, 250);</span>
        const context = <span class="cstat-no" title="statement not covered" >canvas.getContext('2d');</span>
&nbsp;
        // build the QR Code
<span class="cstat-no" title="statement not covered" >        return observableFrom(QRCodeCanvas.toCanvas(canvas, json, {</span>
            errorCorrectionLevel: settings.correctionLevel,
            width: settings.widthPixel,
            // do-not-set-'version'
        }));
