...
<head>
    <title>Code coverage report for symbol-qr-library/src/QRCodeGenerator.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">symbol-qr-library/src</a> QRCodeGenerator.ts</h1>
        <div class='clearfix'>
...
&nbsp;
     ...
     * @param   generationHash         {string}
     */
<span class="fstat-no" title="function not covered" >    public static c</span>reateExportAddress(
        name: string,
        address: string,
        networkType: INetworkType,
        generationHash: string,
    ): AddressQR {
<span class="cstat-no" title="statement not covered" >        return new AddressQR(name, address, networkType, generationHash);</span>
    }
&nbsp;
    /**
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (! json.length) {
<span class="cstat-no" title="statement not covered" >            throw new Error('JSON argument cannot be empty.');</span>
        }
&nbsp;
        let jsonObject: any;
        try {
            jsonObject = JSON.parse(json);
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!jsonObject.type) {
<span class="cstat-no" title="statement not covered" >                throw new Error('Missing mandatory field with name "type".');</span>
            }
        }
        catch (e) {
...
<span class="branch-1 cbranch-no" title="branch not covered" >            case QRCodeType.ExportAddress:</span>
<span class="cstat-no" title="statement not covered" >                return AddressQR.fromJSON(json);</span>
&nbsp;
...
<span class="branch-4 cbranch-no" title="branch not covered" >            case QRCodeType.RequestCosignature:</span>
<span class="cstat-no" title="statement not covered" >                return CosignatureQR.fromJSON(json, transactionCreateFromPayload);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            throw new Error("Unrecognized QR Code 'type': '" + jsonObject.type + "'.");</span>
    }
}
&nbsp;
