...
<head>
    <title>Code coverage report for symbol-qr-library/src/CosignatureQR.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">symbol-qr-library/src</a> CosignatureQR.ts</h1>
        <div class='clearfix'>
...
class CosignatureQR extends TransactionQR implements QRCodeInterface {
    ...
    constructor(/**
        ...
        super(transaction, networkType, generationHash, QRCodeType.RequestCosignature)<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
    }
&nbsp;
    /**
...
&nbsp;
     ...
     * @return {number}
     */
<span class="fstat-no" title="function not covered" >    public g</span>etTypeNumber(): number {
