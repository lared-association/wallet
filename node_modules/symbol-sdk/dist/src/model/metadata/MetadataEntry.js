...
class MetadataEntry {
    ...
    serialize() {
        ...
        const scopedMetadataKey = new catbuffer_typescript_1.ScopedMetadataKeyDto(this.scopedMetadataKey.toDTO());
        /** Target id. */
        const targetId = ((_a = this.targetId) === null || _a === void 0 ? void 0 : _a.id.toDTO()) || [0, 0];
        /** Metadata type. */
        const metadataType = this.metadataType.valueOf();
        /** Value. */
        const value = new catbuffer_typescript_1.MetadataValueBuilder(format_1.Convert.utf8ToUint8(this.value));
        return new catbuffer_typescript_1.MetadataEntryBuilder(sourceAddress, targetAddress, scopedMetadataKey, targetId, metadataType, value).serialize();
    }
}
