...
export declare class MosaicAddressRestriction {
     ...
     */
    readonly restrictions: MosaicAddressRestrictionItem[];
    /**
     * Constructor
     * @param compositeHash
     * @param entryType
     ...
     * Mosaic restriction items
     */
    restrictions: MosaicAddressRestrictionItem[]);
    /**
     * Returns the restriction for a given key.
     *
     * @param key the key.
     */
    getRestriction(key: UInt64): MosaicAddressRestrictionItem | undefined;
    /**
     * Generate buffer
     * @return {Uint8Array}
     */
