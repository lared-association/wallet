...
class AggregateTransaction extends Transaction_1.Transaction {
    ...
    static createFromPayload(payload) {
        ...
        return type === TransactionType_1.TransactionType.AGGREGATE_COMPLETE
            ...
            }), networkType, consignatures, new UInt64_1.UInt64(builder.fee.amount), signature.match(`^[0]+$`) ? undefined : signature, signerPublicKey.match(`^[0]+$`) ? undefined : account_1.PublicAccount.createFromPublicKey(signerPublicKey, networkType))
