...
class MosaicDefinitionTransaction extends Transaction_1.Transaction {
    ...
    static createFromPayload(payload, isEmbedded = false) {
        ...
        const transaction = MosaicDefinitionTransaction.create(isEmbedded
            ...
            : Deadline_1.Deadline.createFromDTO(builder.getDeadline().timestamp), MosaicNonce_1.MosaicNonce.createFromUint8Array(builder.getNonce().serialize()), new MosaicId_1.MosaicId(builder.getId().mosaicId), MosaicFlags_1.MosaicFlags.create(builder.getFlags().indexOf(catbuffer_typescript_1.MosaicFlagsDto.SUPPLY_MUTABLE) > -1, builder.getFlags().indexOf(catbuffer_typescript_1.MosaicFlagsDto.TRANSFERABLE) > -1, builder.getFlags().indexOf(catbuffer_typescript_1.MosaicFlagsDto.RESTRICTABLE) > -1), builder.getDivisibility(), new UInt64_1.UInt64(builder.getDuration().blockDuration), networkType, isEmbedded ? new UInt64_1.UInt64([0, 0]) : new UInt64_1.UInt64(builder.fee.amount), isEmbedded || signature.match(`^[0]+$`) ? undefined : signature, signerPublicKey.match(`^[0]+$`) ? undefined : PublicAccount_1.PublicAccount.createFromPublicKey(signerPublicKey, networkType));
