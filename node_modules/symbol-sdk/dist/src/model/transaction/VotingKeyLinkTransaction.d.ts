...
export declare class VotingKeyLinkTransaction extends Transaction {
     ...
     */
    static create(deadline: Deadline, linkedPublicKey: string, startEpoch: number, endEpoch: number, linkAction: LinkAction, networkType: NetworkType, maxFee?: UInt64, signature?: string, signer?: PublicAccount): VotingKeyLinkTransaction;
    /**
     * @param networkType
     * @param version
     * @param deadline
