...
class NamespaceRegistrationTransaction extends Transaction_1.Transaction {
    ...
    static createSubNamespace(deadline, namespaceName, parentNamespace, networkType, maxFee = new UInt64_1.UInt64([0, 0]), signature, signer) {
        ...
        const namespaceId = typeof parentNamespace === 'string'
            ...
            : new NamespaceId_1.NamespaceId(NamespaceMosaicIdGenerator_1.NamespaceMosaicIdGenerator.namespaceId(namespaceName));
        return new NamespaceRegistrationTransaction(networkType, TransactionVersion_1.TransactionVersion.NAMESPACE_REGISTRATION, deadline, maxFee, NamespaceRegistrationType_1.NamespaceRegistrationType.SubNamespace, namespaceName, namespaceId, undefined, parentId, signature, signer);
    }
    /**
