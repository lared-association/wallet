...
class FinalizationHttp extends Http_1.Http {
    ...
    toFinalizationProof(dto) {
        return new FinalizationProof_1.FinalizationProof(dto.version, dto.finalizationEpoch, dto.finalizationPoint, UInt64_1.UInt64.fromNumericString(dto.height), dto.hash, dto.messageGroups.map((mg) => new MessageGroup_1.MessageGroup(mg.stage.valueOf(), UInt64_1.UInt64.fromNumericString(mg.height), mg.hashes, mg.signatures.map((s) => new BmTreeSignature_1.BmTreeSignature(new ParentPublicKeySignaturePair_1.ParentPublicKeySignaturePair(s.root.parentPublicKey, s.root.signature), new ParentPublicKeySignaturePair_1.ParentPublicKeySignaturePair(s.top.parentPublicKey, s.top.signature), new ParentPublicKeySignaturePair_1.ParentPublicKeySignaturePair(s.bottom.parentPublicKey, s.bottom.signature))))));
    }
}
