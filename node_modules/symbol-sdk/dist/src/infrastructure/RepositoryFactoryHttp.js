...
class RepositoryFactoryHttp {
    ...
    constructor(url, configs) {
        ...
        if ((configs === null || configs === void 0 ? void 0 : configs.generationHash) && (configs === null || configs === void 0 ? void 0 : configs.nodePublicKey)) {
            ...
            this.generationHash = this.cache(() => nodeInfoObservable.pipe(operators_1.map((b) => b.networkGenerationHashSeed)));
            this.nodePublicKey = this.cache(() => nodeInfoObservable.pipe(operators_1.map((b) => b.nodePublicKey)));
        }
