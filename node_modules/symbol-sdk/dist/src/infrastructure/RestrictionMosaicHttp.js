...
const MosaicAddressRestrictionItem_1 = require("../model/restriction/MosaicAddressRestrictionItem");
...
class RestrictionMosaicHttp extends Http_1.Http {
    ...
    static toMosaicRestriction(dto) {
        if (dto.mosaicRestrictionEntry.targetAddress) {
            ...
            return new MosaicAddressRestriction_1.MosaicAddressRestriction(dto.mosaicRestrictionEntry.compositeHash, dto.mosaicRestrictionEntry.entryType.valueOf(), new MosaicId_1.MosaicId(dto.mosaicRestrictionEntry.mosaicId), Address_1.Address.createFromEncoded(addressRestrictionDto.mosaicRestrictionEntry.targetAddress), addressRestrictionDto.mosaicRestrictionEntry.restrictions.map(this.toMosaicAddressRestrictionItem));
        }
        const globalRestrictionDto = dto;
        return new MosaicGlobalRestriction_1.MosaicGlobalRestriction(dto.mosaicRestrictionEntry.compositeHash, dto.mosaicRestrictionEntry.entryType.valueOf(), new MosaicId_1.MosaicId(dto.mosaicRestrictionEntry.mosaicId), globalRestrictionDto.mosaicRestrictionEntry.restrictions.map((i) => this.toMosaicGlobalRestrictionItem(i)));
    }
    static toMosaicGlobalRestrictionItem(restriction) {
        return new MosaicGlobalRestrictionItem_1.MosaicGlobalRestrictionItem(model_1.UInt64.fromNumericString(restriction.key), new MosaicId_1.MosaicId(restriction.restriction.referenceMosaicId), model_1.UInt64.fromNumericString(restriction.restriction.restrictionValue), restriction.restriction.restrictionType.valueOf());
    }
    static toMosaicAddressRestrictionItem(restriction) {
        return new MosaicAddressRestrictionItem_1.MosaicAddressRestrictionItem(model_1.UInt64.fromNumericString(restriction.key), model_1.UInt64.fromNumericString(restriction.value));
    }
}
