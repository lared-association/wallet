...
class Listener {
    ...
    transactionSubscription(channel, unresolvedAddress, transactionHash, subscribeMultisig = false) {
        return this.getResolvedAddress(unresolvedAddress).pipe(operators_1.mergeMap((address) => {
            return this.subscribeWithMultig(address, channel, subscribeMultisig).pipe(operators_1.switchMap((subscribers) => {
    ...
    cosignatureAdded(unresolvedAddress, subscribeMultisig = false) {
        return this.getResolvedAddress(unresolvedAddress).pipe(operators_1.mergeMap((address) => {
            return this.subscribeWithMultig(address, ListenerChannelName.cosignature, subscribeMultisig).pipe(operators_1.switchMap((subscribers) => {
    ...
    subscribeWithMultig(cosigner, channel, multisig = false) {
        ...
        return this.multisigRepository.getMultisigAccountInfo(cosigner).pipe(operators_1.map((multisigInfo) => {
