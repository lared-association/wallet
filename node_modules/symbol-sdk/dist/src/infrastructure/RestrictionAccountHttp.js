...
class RestrictionAccountHttp extends Http_1.Http {
    ...
    getAccountRestrictions(address) {
        return this.call(this.restrictionAccountRoutesApi.getAccountRestrictions(address.plain()), (body) => DtoMapping_1.DtoMapping.extractAccountRestrictionFromDto(body));
    }
}
