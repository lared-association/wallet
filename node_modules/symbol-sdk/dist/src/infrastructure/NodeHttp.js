...
class NodeHttp extends Http_1.Http {
     ...
     */
    toNodeInfo(nodeInfo) {
        return new NodeInfo_1.NodeInfo(nodeInfo.publicKey, nodeInfo.networkGenerationHashSeed, nodeInfo.port, nodeInfo.networkIdentifier, nodeInfo.version, this.getNodeRoles(nodeInfo.roles.valueOf()), nodeInfo.host, nodeInfo.friendlyName, nodeInfo.nodePublicKey);
    }
    /**
